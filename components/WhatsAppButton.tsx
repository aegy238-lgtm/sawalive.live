...
const WhatsAppButton: React.FC<Props> = ({ phoneNumber = "393921700020" }) => {
  ...
  return (
    <div className="fixed bottom-24 left-6 z-[100] animate-in fade-in slide-in-from-bottom-10 duration-700">
      <a 
        href={whatsappUrl}
        target="_blank"
      ...
      >
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="flex flex-col items-start leading-tight">
            <span className="text-[10px] opacity-80 font-bold uppercase tracking-wider">تواصل معنا</span>
